...
jQuery(document).ready(function($){
    ...
    //alert(path);
    if(path == "http://gotripps.com/en/user/register")
    {

    	$('#edit-account > .form-item.form-item-mail > .description').text("A valid e-mail address.");
    }
    if(path == "http://gotripps.com/es/user/register")
    {

    	$('#edit-account > .form-item.form-item-mail > .description').text("Por favor introduzca una dirección de correo electrónico válida.");

    }
    if(path == "http://gotripps.com/pt-br/user/register")
    {

    	$('#edit-account > .form-item.form-item-mail > .description').text("Por favor insira um email válido.");
  ...
  // alert(path);
   var lang_arr =  path.split('/');
   //alert(lang_arr);
  // alert(lang_arr[3]);
   if(lang_arr[3] == 'en')
   {
      $('#block-block-127 > h2').text("Share this Article:");
      $('#block-block-128 > h2').text("Share this Article:");
   }
   if(lang_arr[3] == 'es'){
     $('#block-block-127 > h2').text("Comparte este Artículo:");
     $('#block-block-128 > h2').text("Comparte este Artículo:");
    }
   if(lang_arr[3] == 'pt-br'){
      $('#block-block-127 > h2').text("Compartilhe este Artigo:");
      $('#block-block-128 > h2').text("Compartilhe este Artigo:");
    }
});
