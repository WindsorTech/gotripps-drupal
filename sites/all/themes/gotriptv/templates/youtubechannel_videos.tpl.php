...
<div id="top">
  ...
  <div id="youtubechannel-list" class="youtubechannel-list" style="width: <?php print $vars['width']; ?>px; height="<?php print $vars['height'] ?>"<?php /*?>height: <?php print ($vars['height'] > 140) ? (140) : $vars['height']; ?>px;"><?php */?>
    <ul>
