  ...
  Drupal.behaviors.irCaptchaImageSelectionByClick = {
    attach: function (context, settings) {
      $('.captcha', context).once('imageSelectionByClick', function () {
        ...
        // Hide checkboxes.
        $('.ir-captcha-item-response', $captcha).hide();

        // Handle image click.
        $('.ir-captcha-item-image', $captcha).click(function () {
          var $challenge_item = $(this).parent();

          // Toggle corresponding checkbox.
          var $checkbox = $challenge_item.find('.ir-captcha-item-response .form-checkbox');
          $checkbox.attr('checked', !$checkbox.attr('checked'));

          // Toggle selection indicator.
          $challenge_item.toggleClass('ir-captcha-item-image-selected');
        });
      });
    }
  };
