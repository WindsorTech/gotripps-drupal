...
?>
<div class="clear">&nbsp;</div>
<div class="outer-mainly <?php ($is_administrator) ? print 'administrator': print 'not_administrator';?>">
<?php 
...
if ($language->language == 'pt-br'){
 ...
 print "<h1>Criar álbum de fotos</h1>";
}
elseif ($language->language == 'en'){

 print "<h1>Create Photo Album </h1>";
}
elseif ($language->language == 'es'){

 print "<h1>Crear álbum de fotos</h1>";
}
?>
 ...
 <?php // unset($form['language']); ?>
  ...
  <?php //print ($content['language']); ?>
   ...
   <?php if ($language->language == 'pt-br'){
...
<?php unset($form['media_gallery_description']['#title']); ?>
   <?php print drupal_render($form['media_gallery_description']); ?>
...
<?php //echo "<pre>"; print_r($form); echo "</pre>"; die; ?>
<?php if($buttons): ?> <div class="node-buttons"> <?php //print render($buttons); ?> </div> <?php endif; ?> 

<div class="node-add-wrapper clear-block"> <div class="node-column-sidebar"> <?php if($sidebar): ?> <?php print render($sidebar); ?> <?php endif; ?> </div> <div class="node-column-main"> <?php if($form): ?> <?php print drupal_render_children($form); ?> <?php endif; ?>   <?php if($buttons): ?> <div class="node-buttons"> <?php print render($buttons); ?> </div> <?php endif; ?> </div> <div class="clear"></div> </div>
</div>
<div class="clear">&nbsp;</div>
</div>
